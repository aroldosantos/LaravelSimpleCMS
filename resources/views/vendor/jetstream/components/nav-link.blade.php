...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-gray-400 text-sm font-bold leading-5 text-yellow-500 focus:outline-none focus:border-gray-500 transition'
